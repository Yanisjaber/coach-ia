...
(function () {
  ...
  + '#sb-root .sb-profile{background:var(--bg-elev2,#1b2230);border:1px solid var(--border,#2a3444);border-radius:12px;padding:12px;display:flex;align-items:stretch;gap:4px;height:140px;overflow:hidden}'
  + '#sb-root .sb-pblock{display:flex;flex-direction:column;height:100%;cursor:grab;border-radius:6px;padding:3px 2px 0;min-width:0;outline:1px solid transparent;transition:background .12s,outline .12s}'
  ...
  + '#sb-root .sb-bar{flex:1;border-radius:3px 3px 0 0;min-width:1px;opacity:.92}'
