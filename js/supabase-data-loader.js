...
const ACTIVITY_LIGHT_COLS = [
  ...
  'planned_id', 'power_curve', 'metrics',
].join(',');
...
function reconstituteData({ profile, activities, dailyMetrics, powerProfile, whoopData, stravaConnection, whoopConnection, powerProfileSport }) {
  ...
  function _mapActivityRow(a) {
    ...
    return {
      ...
      power_curve: a.power_curve || null,  // best W par duree (records)
      metrics: a.metrics || null,          // metriques avancees calculees (TRIMP, eFTP, W', CHO...)
      ...
      type: a.type ?? null,
      _exclPower: !!a.excl_power, _exclHr: !!a.excl_hr, _exclDistance: !!a.excl_distance,
